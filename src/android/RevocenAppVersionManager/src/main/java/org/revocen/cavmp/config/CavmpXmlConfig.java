...
public class CavmpXmlConfig {
     ...
     */
    public static CavmpXmlConfig loadFromCordovaConfig(final Context context) {
        CavmpXmlConfig cavmpConfig = new CavmpXmlConfig();

        new CavmpXmlConfigParser().parse(context, cavmpConfig);
